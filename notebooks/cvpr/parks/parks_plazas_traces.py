...
def _(mo):
    mo.md(
        r"""
    # Parks and plazas — reasoning traces

    1 notebook for each prompt, like the validation-by-proxy notebooks. This one
    reads the **parks_plazas** thinking runs and draws the words the model writes
    while it decides.
    ...
    Thus this notebook counts **every** case and draws only **parks_plazas**: the
...
def _(mo):
    ...
    mo.md(
        f"""
    ### 4.3 What parks_plazas names that the other cases do not
