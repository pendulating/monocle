...
def _(mo):
    mo.md(
        r"""
    # Schools — reasoning traces

    1 notebook for each prompt, like the validation-by-proxy notebooks. This one
    reads the **schools** thinking runs and draws the words the model writes
    while it decides.
    ...
    Thus this notebook counts **every** case and draws only **schools**: the
...
def _(mo):
    ...
    mo.md(
        f"""
    ### 4.3 What schools names that the other cases do not
