...
def _(mo):
    mo.md(
        r"""
    # Street photography — reasoning traces

    1 notebook for each prompt, like the validation-by-proxy notebooks. This one
    reads the **street_photography** thinking runs and draws the words the model writes
    while it decides.
    ...
    Thus this notebook counts **every** case and draws only **street_photography**: the
...
def _(mo):
    ...
    mo.md(
        f"""
    ### 4.3 What street_photography names that the other cases do not
