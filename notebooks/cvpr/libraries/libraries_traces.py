...
def _(mo):
    mo.md(
        r"""
    # Libraries — reasoning traces

    1 notebook for each prompt, like the validation-by-proxy notebooks. This one
    reads the **libraries** thinking runs and draws the words the model writes
    while it decides.
    ...
    Thus this notebook counts **every** case and draws only **libraries**: the
...
def _(mo):
    ...
    mo.md(
        f"""
    ### 4.3 What libraries names that the other cases do not
