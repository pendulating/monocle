...
def _(mo):
    mo.md(
        r"""
    # Road quality — reasoning traces

    1 notebook for each prompt, like the validation-by-proxy notebooks. This one
    reads the **road_quality** thinking runs and draws the words the model writes
    while it decides.
    ...
    Thus this notebook counts **every** case and draws only **road_quality**: the
...
def _(mo):
    ...
    mo.md(
        f"""
    ### 4.3 What road_quality names that the other cases do not
