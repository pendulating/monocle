...
class WandbConfig:
    ...
    Fields:
        ...
        env_var_prefix: Prefix for dagspace-specific sanitizer env vars
                        (e.g. "MLLMSCI", "URBANVQA").  Empty string means
    ...
    def from_hydra_config(
        ...
        *,
        ...
        Args:
            ...
            env_var_prefix: Prefix for GPU sanitizer env vars (e.g. "MLLMSCI").
    ...
    *,
    ...
    Args:
        ...
        env_var_prefix: Dagspace prefix for GPU sanitizer env vars (e.g.
            "MLLMSCI" reads MLLMSCI_GPU_SANITIZE_ORIGINAL etc.).  Empty string
