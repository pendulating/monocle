"""Centralized W&B logging for URBANVQA pipeline.
    ...
    def from_hydra_config(cls, cfg) -> "WandbConfig":
        ...
        try:
            ...
            if wandb_cfg is None:
                return cls(
                    enabled=False,
                    project=(env_project or "URBANVQA"),
            ...
            if proj_attr is None or str(proj_attr).strip() == "":
                ...
                project = str(proj_attr or "URBANVQA")
...
def collect_compute_metadata(cfg=None) -> Dict[str, Any]:
    ...
    dropped = os.environ.get("URBANVQA_SANITIZED_DROPPED_GPUS")
    original = os.environ.get("URBANVQA_GPU_SANITIZE_ORIGINAL")
    reason = os.environ.get("URBANVQA_GPU_SANITIZE_REASON")
    ts = os.environ.get("URBANVQA_GPU_SANITIZE_TS")
...
class WandbLogger:
    ...
    def _get_run_name(self) -> str:
        """Generate run name."""
        try:
            exp_name = str(getattr(self.cfg.experiment, "name", "URBANVQA") or "URBANVQA")
        except Exception:
            exp_name = "URBANVQA"
        ...
        try:
            ...
            pipeline_name = os.environ.get("URBANVQA_PIPELINE_NAME") or None
