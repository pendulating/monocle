...
export TFIDF_STOPWORDS_PATH=/path/to/URBANVQA/dagspaces/urbanvqa/conf/stopwords/news_extended.yaml

# Or command line
python -m dagspaces.urbanvqa.cli \
  tfidf_stopwords_path=dagspaces/urbanvqa/conf/stopwords/comprehensive.yaml
```
...
defaults:
  - _self_
  - override tfidf_stopwords_path: dagspaces/urbanvqa/conf/stopwords/minimal.yaml
```
...
nodes:
  topic:
    overrides:
      tfidf_stopwords_path: dagspaces/urbanvqa/conf/stopwords/news_extended.yaml
```
...
```bash
python -m dagspaces.urbanvqa.cli \
  tfidf_stopwords_path=dagspaces/urbanvqa/conf/stopwords/my_domain.yaml
```
...
with open('dagspaces/urbanvqa/conf/stopwords/news_extended.yaml') as f:
...
with open('dagspaces/urbanvqa/conf/stopwords/combined.yaml', 'w') as f:
...
python -m dagspaces.urbanvqa.cli \
  ...
  tfidf_stopwords_path=dagspaces/urbanvqa/conf/stopwords/minimal.yaml
```
...
```bash
export TFIDF_STOPWORDS_PATH=$PWD/dagspaces/urbanvqa/conf/stopwords/news_extended.yaml
python -m dagspaces.urbanvqa.cli pipeline=topic_modeling_of_relevant_classifications
```
...
nodes:
  topic:
    stage: topic
    overrides:
      tfidf_stopwords_path: ${oc.env:PWD}/dagspaces/urbanvqa/conf/stopwords/comprehensive.yaml
...
- **URBANVQA Topic Modeling Guide**: `/docs/USER_GUIDE.md`
