...
_PATCH_MODULE = "dagspaces.urbanocr.resource_tracker_patch"
...
def _wrap_cleanup_funcs(rt_module) -> None:
    ...
    for rtype, func in list(rt_module._CLEANUP_FUNCS.items()):  # noqa: SLF001
        ...
        if getattr(func, "__urbanocr_wrapped__", False):
            continue
        ...
        _wrapped.__urbanocr_wrapped__ = True  # type: ignore[attr-defined]
